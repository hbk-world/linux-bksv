...
static const char *pll_bypass_src_sel[] = { "osc", "ccm_clk1","ccm_clk2","dummy", };
...
static void __init imx7d_clocks_init(struct device_node *ccm_node)
{
	...
	clks[IMX7D_CKIL] = of_clk_get_by_name(ccm_node, "ckil");
 	clks[IMX7D_CCM_CLK1]    = of_clk_get_by_name(ccm_node, "ccm_clk1");
	clks[IMX7D_CCM_CLK2]    = of_clk_get_by_name(ccm_node, "ccm_clk2");
	...
	clks[IMX7D_PLL_AUDIO_MAIN] = imx_clk_pllv3(IMX_PLLV3_AV_IMX7, "pll_audio_main", "pll_audio_main_src", base + 0xf0, 0x7f);
	...
	imx_clk_set_parent(clks[IMX7D_UART5_ROOT_SRC], clks[IMX7D_OSC_24M_CLK]);
	imx_clk_set_rate(clks[IMX7D_UART5_ROOT_DIV], 24000000);
